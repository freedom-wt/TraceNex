...
const bar_3d_1 = require("../../../series/bar/bar-3d"), type_1 = require("../../../series/interface/type"), base_1 = require("../base/base"), factory_1 = require("../../../core/factory"), histogram_transformer_1 = require("../histogram-transformer");
...
Histogram3dChart.seriesType = type_1.SeriesTypeEnum.bar3d, Histogram3dChart.view = "singleDefault", 
Histogram3dChart.transformerConstructor = histogram_transformer_1.HistogramChartSpecTransformer;

const registerHistogram3dChart = () => {
    (0, bar_3d_1.registerBar3dSeries)(), factory_1.Factory.registerChart(Histogram3dChart.type, Histogram3dChart);
};
