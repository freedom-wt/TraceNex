...
const type_1 = require("../../../series/interface/type"), funnel_3d_1 = require("../../../series/funnel/3d/funnel-3d"), factory_1 = require("../../../core/factory"), funnel_transformer_1 = require("../funnel-transformer"), base_1 = require("../../base");
...
Funnel3dChart.view = "singleDefault", Funnel3dChart.transformerConstructor = funnel_transformer_1.FunnelChartSpecTransformer;

const registerFunnel3dChart = () => {
    (0, funnel_3d_1.registerFunnel3dSeries)(), factory_1.Factory.registerChart(Funnel3dChart.type, Funnel3dChart);
};
