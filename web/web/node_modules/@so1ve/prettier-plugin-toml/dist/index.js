// ../../node_modules/.pnpm/prettier-plugin-toml@1.0.1_prettier@3.0.3/node_modules/prettier-plugin-toml/lib/loc.js
...
function findInvalidGroupType(tokenTypes) {
  const invalidTypes = filter_default(tokenTypes, (clazz) => {
    ...
    return group2 !== Lexer.SKIPPED && group2 !== Lexer.NA && !isString_default(group2);
  });
...
var defaultLexerErrorProvider = {
  ...
  buildUnexpectedCharactersMessage(fullText, startOffset, length, line2, column) {
...
var Lexer = class {
  constructor(lexerDefinition, config = DEFAULT_LEXER_CONFIG) {
    ...
    this.TRACE_INIT = (phaseDesc, phaseImpl) => {
      if (this.traceInitPerf === true) {
        ...
        const indent2 = new Array(this.traceInitIndent + 1).join("	");
  ...
  tokenizeInternal(text, initialMode) {
    let i, j, k, matchAltImage, longerAlt, matchedImage, payload, altPayload, imageLength, group2, tokType, newToken, errLength, droppedChar, msg, match;
    const orgText = text;
      ...
      if (matchedImage !== null) {
        ...
        if (trackLines === true && currConfig.canLineTerminator === true) {
          ...
          if (numOfLTsInMatch !== 0) {
            ...
            this.updateTokenEndLineColumnLocation(newToken, group2, lastLTEndOffset, numOfLTsInMatch, line2, column, imageLength);
          }
        }
  ...
  updateTokenEndLineColumnLocation(newToken, group2, lastLTIdx, numOfLTsInMatch, line2, column, imageLength) {
...
// ../../node_modules/.pnpm/@toml-tools+lexer@1.0.1/node_modules/@toml-tools/lexer/lib/tokens.js
var fragments = {};
var f = fragments;
...
var Newline = createToken2({ name: "Newline", pattern: /\n|\r\n/ });
...
createToken2({ name: "KeyValSep", pattern: "=" });
createToken2({ name: "Dot", pattern: "." });
var IKey = createToken2({ name: "IKey", pattern: Lexer.NA });
var IQuotedKey = createToken2({
  name: "IQuotedKey",
  pattern: Lexer.NA,
  categories: [IKey]
});
var IUnquotedKey = createToken2({
  name: "IUnquotedKey",
  pattern: Lexer.NA,
  categories: [IKey]
});
var IString = createToken2({ name: "IString", pattern: Lexer.NA });
FRAGMENT(
  "basic_unescaped",
  /[\u0020-\u0021]|[\u0023-\u005B]|[\u005D-\u007E]|[\u0080-\uFFFF]/
);
...
var IBoolean = createToken2({
  name: "IBoolean",
  pattern: Lexer.NA,
  categories: [IUnquotedKey]
});
var True = createToken2({
  name: "True",
  pattern: /true/,
  categories: [IBoolean]
});
var False = createToken2({
  name: "False",
  pattern: /false/,
  categories: [IBoolean]
});
var IDateTime = createToken2({
  name: "IDateTime",
  pattern: Lexer.NA
});
...
var IFloat = createToken2({
  name: "IFloat",
  pattern: Lexer.NA
});
var decimalIntPatern = /[+-]?(?:0|[1-9](?:_?\d)*)/;
...
var IInteger = createToken2({
  name: "IInteger",
  pattern: Lexer.NA
});
var DecimalInt = createToken2({
  name: "DecimalInt",
...
var UnquotedKey = createToken2({
  name: "UnquotedKey",
  pattern: /[A-Za-z0-9_-]+/,
  categories: [IUnquotedKey]
});
var possibleUnquotedKeysPrefixes = [True, False, DecimalInt];
possibleUnquotedKeysPrefixes.forEach((tokType) => {
  tokType.LONGER_ALT = UnquotedKey;
});

// ../../node_modules/.pnpm/@toml-tools+lexer@1.0.1/node_modules/@toml-tools/lexer/lib/api.js
var tomlLexer = new Lexer(tokensArray, {
...
// ../../node_modules/.pnpm/@toml-tools+parser@1.0.1/node_modules/@toml-tools/parser/lib/parser.js
var TomlParser = class extends CstParser {
  constructor() {
    ...
    $.RULE("expression", () => {
      $.OR(
        ...
        $.C2 || ($.C2 = [
          { ALT: () => $.SUBRULE($.keyval) },
          { ALT: () => $.SUBRULE($.table) },
          { ALT: () => $.CONSUME(tokensDictionary.Comment) }
        ])
      );
      $.OPTION(() => {
        $.CONSUME2(tokensDictionary.Comment);
      });
    });
    $.RULE("keyval", () => {
      $.SUBRULE($.key);
      $.CONSUME(tokensDictionary.KeyValSep);
      $.SUBRULE($.val);
    });
    $.RULE("key", () => {
      $.CONSUME(tokensDictionary.IKey);
      $.MANY(() => {
        $.CONSUME(tokensDictionary.Dot);
        $.CONSUME2(tokensDictionary.IKey);
      });
    });
    $.RULE("val", () => {
      $.OR(
        $.C1 || ($.C1 = [
          { ALT: () => $.CONSUME(tokensDictionary.IString) },
          { ALT: () => $.CONSUME(tokensDictionary.IBoolean) },
          { ALT: () => $.SUBRULE($.array) },
          { ALT: () => $.SUBRULE($.inlineTable) },
          { ALT: () => $.CONSUME(tokensDictionary.IDateTime) },
          { ALT: () => $.CONSUME(tokensDictionary.IFloat) },
          { ALT: () => $.CONSUME(tokensDictionary.IInteger) }
        ])
      );
    });
    $.RULE("array", () => {
      $.CONSUME(tokensDictionary.LSquare);
      $.OPTION(() => {
        $.SUBRULE($.arrayValues);
      });
      $.SUBRULE($.commentNewline);
      $.CONSUME(tokensDictionary.RSquare);
    });
    $.RULE("arrayValues", () => {
      $.SUBRULE($.commentNewline);
      $.SUBRULE($.val);
      ...
      $.MANY({
        GATE: () => notDangling,
        DEF: () => {
          $.CONSUME(tokensDictionary.Comma);
    ...
    $.RULE("inlineTable", () => {
      $.CONSUME(tokensDictionary.LCurly);
      $.OPTION(() => {
        $.SUBRULE($.inlineTableKeyVals);
      });
      $.CONSUME(tokensDictionary.RCurly);
    });
    ...
    $.RULE("table", () => {
      $.OR({
        ...
        DEF: [
          {
            GATE: () => $.LA(2).tokenType !== tokensDictionary.LSquare,
    ...
    $.RULE("arrayTable", () => {
      $.CONSUME(tokensDictionary.LSquare);
      $.CONSUME2(tokensDictionary.LSquare);
      $.SUBRULE($.key);
      $.CONSUME(tokensDictionary.RSquare);
      $.CONSUME2(tokensDictionary.RSquare);
    });
    $.RULE("nl", () => {
      $.AT_LEAST_ONE(() => {
        $.CONSUME(tokensDictionary.Newline);
      });
    });
    $.RULE("commentNewline", () => {
      $.MANY(() => {
        $.OPTION(() => {
          $.CONSUME(tokensDictionary.Comment);
        });
        $.CONSUME(tokensDictionary.Newline);
      });
    });
...
// ../../node_modules/.pnpm/@toml-tools+parser@1.0.1/node_modules/@toml-tools/parser/lib/api.js
var parser = new TomlParser();
var BaseTomlCstVisitor = parser.getBaseCstVisitorConstructor();
var BaseTomlCstVisitorWithDefaults = parser.getBaseCstVisitorConstructorWithDefaults();
...
// ../../node_modules/.pnpm/prettier-plugin-toml@1.0.1_prettier@3.0.3/node_modules/prettier-plugin-toml/lib/printer.js
import { doc, version } from "prettier";

// ../../node_modules/.pnpm/prettier-plugin-toml@1.0.1_prettier@3.0.3/node_modules/prettier-plugin-toml/lib/printer-utils.js
...
// ../../node_modules/.pnpm/prettier-plugin-toml@1.0.1_prettier@3.0.3/node_modules/prettier-plugin-toml/lib/printer.js
var { join, line, hardline, softline, ifBreak, indent, group } = doc.builders;
var TomlBeautifierVisitor = class extends BaseTomlCstVisitor {
  constructor() {
    super();
  ...
  toml(ctx) {
    if (ctx.expression === void 0) {
      return [line];
    }
    function isTable(node) {
      return node.children.table !== void 0;
    }
    function isOnlyComment(node) {
      return node.children.Comment !== void 0 && Object.keys(node.children).length === 1;
    }
    ...
    const docGroupsInnerNewlines = docGroups.map(
      (currGroup) => join(line, currGroup)
    );
  ...
  val(ctx) {
    ...
    if (actualValueNode.image !== void 0) {
  ...
  arrayValues(ctx) {
    ...
    for (let i = 0; i < itemsCst.length; i++) {
      ...
      if (cstItem.name === "val") {
        ...
        let potentialComma = "";
        if (itemsCst[i + 1] !== void 0) {
          let nextPossibleComment = itemsCst[i + 1];
          if (nextPossibleComment.tokenType === tokensDictionary.Comma) {
            potentialComma = ",";
            i++;
            nextPossibleComment = itemsCst[i + 1];
          }
          if (nextPossibleComment !== void 0 && nextPossibleComment.tokenType === tokensDictionary.Comment && nextPossibleComment.startLine === valEndLine) {
            i++;
      ...
      } else if (cstItem.tokenType === tokensDictionary.Comment) {
...
var beautifierVisitor = new TomlBeautifierVisitor();
function print(path, options, print2) {
  const cst = path.getValue();
  const doc2 = beautifierVisitor.visit(cst);
  return doc2;
}

// ../../node_modules/.pnpm/prettier-plugin-toml@1.0.1_prettier@3.0.3/node_modules/prettier-plugin-toml/lib/api.js
var languages = [
  {
    extensions: [".toml"],
    name: "Toml",
...
var parsers = {
  toml: {
    astFormat: "toml-cst",
    parse: (text, parsers2, options) => parse(text),
    locStart,
    locEnd
  }
};
