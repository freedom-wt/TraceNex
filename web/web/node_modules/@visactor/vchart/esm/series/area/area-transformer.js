...
export class AreaSeriesSpecTransformer extends LineLikeSeriesSpecTransformer {
    ...
    _transformSpecAfterMergingTheme(spec, chartSpec, chartSpecInfo) {
        ...
        area.support3d = !(!area.support3d && !line.support3d), area.zIndex = isValid(area.zIndex) || isValid(line.zIndex) ? Math.max(null !== (_d = area.zIndex) && void 0 !== _d ? _d : 0, null !== (_e = line.zIndex) && void 0 !== _e ? _e : 0) : void 0, 
        ...
        isAreaVisible || (area.style.fill = !1), isLineVisible || (area.style.stroke = !1), 
        area.visible = !(!isAreaVisible && !isLineVisible), spec.area = area, spec.line = line;
    }
}
