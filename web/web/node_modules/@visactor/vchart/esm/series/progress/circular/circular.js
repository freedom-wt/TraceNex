...
export class CircularProgressSeries extends ProgressLikeSeries {
    constructor() {
        super(...arguments), this.type = SeriesTypeEnum.circularProgress, this._progressMark = null, 
...
export const registerCircularProgressSeries = () => {
    registerProgressArcMark(), registerArcMark(), registerProgressLikeAnimation(), registerFadeInOutAnimation(), 
