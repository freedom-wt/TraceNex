...
Pie3dChart.type = "pie3d", Pie3dChart.seriesType = SeriesTypeEnum.pie3d, Pie3dChart.view = "singleDefault", 
Pie3dChart.transformerConstructor = Pie3dChartSpecTransformer;

export const registerPie3dChart = () => {
    registerPie3dSeries(), Factory.registerChart(Pie3dChart.type, Pie3dChart);
};
