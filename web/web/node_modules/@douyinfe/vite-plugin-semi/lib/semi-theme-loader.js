...
exports.semiThemeLoader = void 0;
const componentName_1 = __importDefault(require("./componentName"));
function semiThemeLoader(source, options) {
    ...
    if (shouldInject) {
        const customStr = (() => {
            ...
            try {
                ...
                const collectAllVariablesPath = [...componentName_1.default];
                if (componentVariables) {
...
exports.semiThemeLoader = semiThemeLoader;
