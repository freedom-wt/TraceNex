...
const base_series_1 = require("../base/base-series"), constant_1 = require("../../constant"), type_1 = require("../../util/type"), vutils_1 = require("@visactor/vutils"), vscale_1 = require("@visactor/vscale"), utils_1 = require("../util/utils");
...
class CartesianSeries extends base_series_1.BaseSeries {
    constructor() {
        super(...arguments), this.coordinate = "cartesian", this._bandPosition = .5, this._scaleConfig = {
            ...
            var _a, _b;
            return !((null === (_a = this._xAxisHelper) || void 0 === _a ? void 0 : _a.isContinuous) && !(0, 
            type_1.couldBeValidNumber)(datum[this._specXField[0]])) && !((null === (_b = this._yAxisHelper) || void 0 === _b ? void 0 : _b.isContinuous) && !(0, 
            type_1.couldBeValidNumber)(datum[this._specYField[0]]));
        };
    }
    _buildScaleConfig() {
        this._scaleConfig = {
    ...
    getStatisticFields() {
        ...
        return (null === (_a = this.getXAxisHelper()) || void 0 === _a ? void 0 : _a.getScale) && (this._fieldX2 ? [ ...this._fieldX, this._fieldX2 ] : this._fieldX).forEach((f => {
            ...
            (0, vscale_1.isContinuous)(this.getXAxisHelper().getScale(0).type) ? result.operations = [ "max", "min" ] : result.operations = [ "values" ], 
            fields.push(result);
            ...
            (0, vscale_1.isContinuous)(this.getYAxisHelper().getScale(0).type) ? result.operations = [ "max", "min" ] : result.operations = [ "values" ], 
            fields.push(result);
            ...
            (0, vscale_1.isContinuous)(this.getZAxisHelper().getScale(0).type) ? result.operations = [ "max", "min" ] : result.operations = [ "values" ], 
            fields.push(result);
    ...
    getStackValue() {
        var _a;
        return null !== (_a = this._spec.stackValue) && void 0 !== _a ? _a : `${constant_1.PREFIX}_series_${this.type}_${("horizontal" === this.direction ? this.getXAxisHelper() : this.getYAxisHelper()).getAxisId()}`;
    }
    getStackValueField() {
        return "vertical" === this.direction ? (0, vutils_1.array)(this._spec.yField)[0] : (0, 
        vutils_1.array)(this._spec.xField)[0];
    }
    setValueFieldToStack() {
        "vertical" === this.direction ? (this.setFieldY(constant_1.STACK_FIELD_END), this.setFieldY2(constant_1.STACK_FIELD_START)) : (this.setFieldX(constant_1.STACK_FIELD_END), 
        this.setFieldX2(constant_1.STACK_FIELD_START));
    }
    setValueFieldToPercent() {
        "vertical" === this.direction ? (this.setFieldY(constant_1.STACK_FIELD_END_PERCENT), 
        this.setFieldY2(constant_1.STACK_FIELD_START_PERCENT)) : (this.setFieldX(constant_1.STACK_FIELD_END_PERCENT), 
        this.setFieldX2(constant_1.STACK_FIELD_START_PERCENT));
    }
    setValueFieldToStackOffsetSilhouette() {
        "vertical" === this.direction ? (this.setFieldY(constant_1.STACK_FIELD_END_OffsetSilhouette), 
        this.setFieldY2(constant_1.STACK_FIELD_START_OffsetSilhouette)) : (this.setFieldX(constant_1.STACK_FIELD_END_OffsetSilhouette), 
        this.setFieldX2(constant_1.STACK_FIELD_START_OffsetSilhouette));
    }
    onXAxisHelperUpdate() {
    ...
    setAttrFromSpec() {
        ...
        this._stackOffsetSilhouette && this.setValueFieldToStackOffsetSilhouette(), (0, 
        vutils_1.isValid)(this._spec.sortDataByAxis) && (this._sortDataByAxis = !0 === this._spec.sortDataByAxis);
    }
    ...
    dataToPositionX(datum) {
        ...
        this._xAxisHelper.dataToPosition((0, vutils_1.array)(this.getDatumPositionValues(datum, fields)), this._scaleConfig)), 
    ...
    dataToPositionY(datum) {
        ...
        this._yAxisHelper.dataToPosition((0, vutils_1.array)(this.getDatumPositionValues(datum, fields)), this._scaleConfig)), 
