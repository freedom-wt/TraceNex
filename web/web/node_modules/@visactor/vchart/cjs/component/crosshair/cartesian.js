...
class CartesianCrossHair extends base_1.BaseCrossHair {
    static getSpecInfo(chartSpec) {
        ...
        if (!(0, vutils_1.isArray)(crosshairSpec)) return crosshairSpec.xField || crosshairSpec.yField ? [ {
            spec: crosshairSpec,
            specPath: [ this.specKey ],
            type: type_1.ComponentTypeEnum.cartesianCrosshair
        } ] : void 0;
        const specInfos = [];
    ...
    layoutByValue(tag = 3) {
        ...
        if (this._xHair && this._currValueX.forEach((({axis: axis, v: v}) => {
            ...
            if ((0, vscale_1.isDiscrete)(xScale.type)) indexWidth = xScale.bandwidth(), 0 === indexWidth && xScale.step && (offsetWidth = xScale.step()); else if ((0, 
            ...
            if ((0, vscale_1.isDiscrete)(yScale.type)) valueHeight = yScale.bandwidth(), 0 === valueHeight && yScale.step && (offsetHeight = yScale.step()); else if ((0, 
