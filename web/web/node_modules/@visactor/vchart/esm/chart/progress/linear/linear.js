...
export class LinearProgressChart extends BaseChart {
    constructor() {
        ...
        this.type = "linearProgress", this.seriesType = SeriesTypeEnum.linearProgress, this._canStack = !0;
    }
}

LinearProgressChart.type = "linearProgress", LinearProgressChart.seriesType = SeriesTypeEnum.linearProgress, 
LinearProgressChart.view = "singleDefault", LinearProgressChart.transformerConstructor = LinearProgressChartSpecTransformer;
