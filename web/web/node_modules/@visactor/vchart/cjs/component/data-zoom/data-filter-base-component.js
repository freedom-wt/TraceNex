...
const model_1 = require("../../util/model"), base_component_1 = require("../base/base-component"), util_1 = require("./util"), register_1 = require("../../data/register"), vscale_1 = require("@visactor/vscale"), common_1 = require("../axis/cartesian/util/common"), vutils_1 = require("@visactor/vutils"), vdataset_1 = require("@visactor/vdataset"), compilable_data_1 = require("../../compile/data/compilable-data"), zoomable_1 = require("../../interaction/zoom/zoomable"), initialize_1 = require("../../data/initialize"), constant_1 = require("../../constant");
...
class DataFilterBaseComponent extends base_component_1.BaseComponent {
    ...
    _updateRangeFactor(tag, label) {
        ...
        if (reverse) switch (tag) {
          ...
          default:
            axisScale.rangeFactorStart(newRangeFactor[0], !0), axisScale.rangeFactorEnd(newRangeFactor[1]);
        } else switch (tag) {
          case "startHandler":
            axisScale.rangeFactorStart(newRangeFactor[0]);
            break;
          ...
          default:
            axisScale.rangeFactorEnd(newRangeFactor[1], !0), axisScale.rangeFactorStart(newRangeFactor[0]);
        }
    ...
    constructor(spec, options) {
        ...
        this._stateField = "x", this._activeRoam = !0, this._zoomAttr = {
            enable: !0,
            rate: 1,
            focus: !0
        }, this._dragAttr = {
            ...
            onZoomChange: tag => {
                ...
                if (axis && "axis" === this._filterMode) {
                    ...
                    axisScale.maxBandwidth("auto"), axisScale.minBandwidth("auto")), this._updateRangeFactor(tag, "zoomChange"), 
                    null === (_b = null === (_a = this._component) || void 0 === _a ? void 0 : _a.setStartAndEnd) || void 0 === _b || _b.call(_a, this._start, this._end), 
            ...
            return this._scrollAttr.reverse || (value = -value), active && this._handleChartMove(value, null !== (_a = this._scrollAttr.rate) && void 0 !== _a ? _a : 1), 
            active;
    ...
    onDataUpdate() {
        ...
        this._stateScale.domain(domain, !0), this._handleChange(this._start, this._end, !0);
    }
    ...
    _initData() {
        ...
        if (this._relatedAxisComponent) {
            ...
            (0, model_1.eachSeries)(this._regions, (s => {
                ...
                vscale_1.isContinuous)(valueAxisHelper.getScale(0).type);
                isValidateValueAxis && (hasValidateValueField = !0), dataCollection.push(s.getRawData());
                const seriesSpec = s.getSpec(), xFields = (0, vutils_1.array)(seriesSpec.xField), yFields = (0, 
                vutils_1.array)(seriesSpec.yField), xField = "cartesian" === s.coordinate ? xFields[0] : null !== (_a = seriesSpec.angleField) && void 0 !== _a ? _a : seriesSpec.categoryField, yField = "cartesian" === s.coordinate ? yFields[0] : null !== (_b = seriesSpec.radiusField) && void 0 !== _b ? _b : seriesSpec.valueField;
                if (originalStateFields[s.id] = "link" === s.type ? "from_xField" : stateAxisHelper === xAxisHelper ? xField : yField, 
                stateFields.push(originalStateFields[s.id]), this._valueField) {
        ...
        } else hasValidateValueField = (0, vutils_1.isNil)(this._spec.valueField), (0, model_1.eachSeries)(this._regions, (s => {
    ...
    _setStateFromSpec() {
        ...
        if (this._auto = !!this._spec.auto, this._spec.rangeMode) {
            ...
            this._modeCheck("start", startMode) && this._modeCheck("end", endMode) && (start = "percent" === startMode ? this._spec.start : this._dataToStatePoint(this._spec.startValue), 
            end = "percent" === endMode ? this._spec.end : this._dataToStatePoint(this._spec.endValue));
        } else start = this._spec.start ? this._spec.start : this._spec.startValue ? this._dataToStatePoint(this._spec.startValue) : 0, 
        ...
        vscale_1.isContinuous)(this._stateScale.type) && this._stateScale.domain[0] !== this._stateScale.domain[1] && (this._spec.minValueSpan && (this._minSpan = this._spec.minValueSpan / (this._stateScale.domain()[1] - this._stateScale.domain()[0])), 
        this._spec.maxValueSpan && (this._maxSpan = this._spec.maxValueSpan / (this._stateScale.domain()[1] - this._stateScale.domain()[0]))), 
    ...
    _initCommonEvent() {
        ...
        this._zoomAttr.enable && this.initZoomEventOfRegions(this._regions, null, this._handleChartZoom, option), 
    ...
    onLayoutStart(layoutRect, viewRect, ctx) {
        ...
        this.layout.setLayoutRect({
            ...
            [sizeKey]: constant_1.AttributeLevel.Built_In
        });
    }
    ...
    _autoUpdate(rect) {
        ...
        if ((0, vscale_1.isDiscrete)(axisScale.type) && (null == rect ? void 0 : rect.height) === (null === (_a = this._cacheRect) || void 0 === _a ? void 0 : _a.height) && (null == rect ? void 0 : rect.width) === (null === (_b = this._cacheRect) || void 0 === _b ? void 0 : _b.width) && this._fixedBandSize === (null == bandSizeResult ? void 0 : bandSizeResult.bandSize)) return this._cacheVisibility;
        let isShown = !0;
        ...
        return this.setStartAndEnd(this._start, this._end), isShown ? this.show() : this.hide(), 
        this._cacheVisibility = isShown, isShown;
    }
