...
class MarkLine extends base_marker_1.BaseMarker {
    ...
    _createMarkerComponent() {
        ...
        startSymbol.visible ? markLineAttrs.startSymbol = Object.assign(Object.assign({}, startSymbol), {
            visible: !0,
            style: (0, style_1.transformToGraphic)(startSymbol.style)
        }) : markLineAttrs.startSymbol = {
            visible: !1
        }, endSymbol.visible ? markLineAttrs.endSymbol = Object.assign(Object.assign({}, endSymbol), {
            visible: !0,
            style: (0, style_1.transformToGraphic)(endSymbol.style)
        }) : markLineAttrs.endSymbol = {
            visible: !1
        };
        return new vrender_components_1.MarkLine(markLineAttrs);
    }
    _markerLayout() {
        ...
        vutils_1.isValid)(spec.process.x), isValidProcessY = isValidProcess && (0, vutils_1.isValid)(spec.process.y), isCoordinateLayout = isValidCoordinates && (!isValidProcess || "process" in spec && "xy" in spec.process), isPositionLayout = (0, 
        vutils_1.isValid)(spec.positions), autoRange = null !== (_a = spec.autoRange) && void 0 !== _a && _a;
        let points = [];
        ...
        } else isCoordinateLayout ? points = (0, utils_1.coordinateLayout)(data, relativeSeries, autoRange, spec.coordinatesOffset) : isPositionLayout && (points = (0, 
        ...
        if ("type-step" === this._spec.type) {
            ...
            const joinPoints = (0, util_1.getInsertPoints)(points[0], points[1], connectDirection, expandDistanceValue);
...
exports.MarkLine = MarkLine, MarkLine.type = type_1.ComponentTypeEnum.markLine, 
MarkLine.specKey = "markLine";

const registerMarkLine = () => {
    factory_1.Factory.registerComponent(MarkLine.type, MarkLine);
};
