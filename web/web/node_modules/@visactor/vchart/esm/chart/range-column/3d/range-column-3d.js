...
RangeColumn3dChart.view = "singleDefault", RangeColumn3dChart.transformerConstructor = RangeColumn3dChartSpecTransformer;

export const registerRangeColumn3dChart = () => {
    registerRangeColumn3dSeries(), Factory.registerChart(RangeColumn3dChart.type, RangeColumn3dChart);
};
