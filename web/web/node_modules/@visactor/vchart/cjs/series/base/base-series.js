...
const event_1 = require("../../constant/event"), index_1 = require("../../constant/index"), theme_1 = require("../interface/theme"), vdataset_1 = require("@visactor/vdataset"), base_model_1 = require("../../model/base-model"), initialize_1 = require("../../data/initialize"), data_1 = require("../../util/data"), type_1 = require("../../util/type"), merge_spec_1 = require("../../util/spec/merge-spec"), add_property_1 = require("../../data/transforms/add-property"), trigger_1 = require("../../interaction/trigger"), register_1 = require("../../data/register"), tooltip_helper_1 = require("./tooltip-helper"), dimension_statistics_1 = require("../../data/transforms/dimension-statistics"), invalid_travel_1 = require("../../data/transforms/invalid-travel"), util_1 = require("../../theme/color-scheme/util"), series_data_1 = require("./series-data"), data_key_1 = require("../../data/transforms/data-key"), vutils_1 = require("@visactor/vutils"), color_ordinal_scale_1 = require("../../scale/color-ordinal-scale"), constant_1 = require("./constant"), utils_1 = require("../../animation/utils"), base_series_transformer_1 = require("./base-series-transformer");
...
class BaseSeries extends base_model_1.BaseModel {
    ...
    setSeriesField(field) {
        (0, vutils_1.isValid)(field) && (this._seriesField = field, this.getMarks().filter((m => m.getDataView() === this.getViewData())).forEach((m => {
    ...
    getStackValue() {
        var _a;
        return null !== (_a = this._spec.stackValue) && void 0 !== _a ? _a : `${index_1.PREFIX}_series_${this.type}`;
    }
    getPercent() {
    ...
    constructor(spec, options) {
        ...
        this.layoutZIndex = 0, this._invalidType = "break", this._getInvalidDefined = datum => (0, 
        type_1.couldBeValidNumber)(datum[this.getStackValueField()]), this._region = options.region, 
        this._dataSet = options.dataSet, (null === (_a = this._spec) || void 0 === _a ? void 0 : _a.name) && (this.name = this._spec.name);
    }
    created() {
    ...
    setAttrFromSpec() {
        super.setAttrFromSpec(), this.setSeriesField(this._spec.seriesField), (0, vutils_1.isBoolean)(this._spec.stack) && (this._stack = this._spec.stack), 
        (0, vutils_1.isBoolean)(this._spec.percent) && (this._percent = this._spec.percent, 
        this._stack = this._spec.percent || this._stack), (0, vutils_1.isBoolean)(this._spec.stackOffsetSilhouette) && (this._stackOffsetSilhouette = this._spec.stackOffsetSilhouette, 
        this._stack = this._spec.stackOffsetSilhouette || this._stack), (0, vutils_1.isValid)(this._spec.stackValue) && (this._stack = !0), 
        (0, vutils_1.isNil)(this._stack) && this._supportStack && this._seriesField && (this._stack = !0), 
        (0, vutils_1.isValid)(this._spec.invalidType) && (this._invalidType = this._spec.invalidType);
    }
    initData() {
        ...
        this._addDataIndexAndKey(), this._rawData) {
            this._stack && (this._viewDataFilter = (0, initialize_1.dataViewFromDataView)(this._rawData, this._dataSet, {
                name: `${this.type}_${this.id}_viewDataFilter`
            }));
            const viewData = (0, initialize_1.dataViewFromDataView)(this._stack ? this._viewDataFilter : this._rawData, this._dataSet, {
                name: `${this.type}_${this.id}_viewData`
            });
            this._data = new series_data_1.SeriesData(this._option, viewData), this._stack && this._viewDataFilter.target.removeListener("change", viewData.reRunAllTransform);
        }
        "zero" === this._invalidType && (null === (_e = this._rawData) || void 0 === _e ? void 0 : _e.dataSet) && ((0, 
    ...
    getRawDataStatisticsByField(field, isNumeric) {
        ...
        if (this._rawStatisticsCache || (this._rawStatisticsCache = {}), !this._rawStatisticsCache[field]) {
            if (this._viewDataStatistics && (!this._viewDataFilter || this._viewDataFilter.transformsArr.length <= 1) && this.getViewData().transformsArr.length <= 1 && (null === (_a = this._viewDataStatistics.latestData) || void 0 === _a ? void 0 : _a[field])) this._rawStatisticsCache[field] = this._viewDataStatistics.latestData[field]; else if (this._rawData) {
                ...
                this._rawStatisticsCache[field].max = (0, vutils_1.maxInArray)(fieldInfo.domain)) : this._rawStatisticsCache[field].values = fieldInfo.domain) : this._rawStatisticsCache[field] = (0, 
                dimension_statistics_1.dimensionStatisticsOfSimpleData)(this._rawData.latestData, [ {
                    key: field,
                    operations: isNumeric ? [ "min", "max" ] : [ "values" ]
                } ])[field];
            }
        }
        return isNumeric && ((0, vutils_1.isNil)(this._rawStatisticsCache[field].min) || (0, 
        vutils_1.isNil)(this._rawStatisticsCache[field].max)) && (this._rawStatisticsCache[field].min = (0, 
        vutils_1.minInArray)(this._rawStatisticsCache[field].values), this._rawStatisticsCache[field].max = (0, 
        vutils_1.maxInArray)(this._rawStatisticsCache[field].values)), this._rawStatisticsCache[field];
    }
    _statisticViewData() {
        ...
        this._viewDataStatistics = new vdataset_1.DataView(this._dataSet, {
            ...
            options: {
                fields: () => {
                    ...
                    return this._seriesField && (0, data_1.mergeFields)(fields, [ {
    ...
    createStatisticalData(dataName, rawData, staticFields) {
        ...
        return data.parse([ rawData ], {
            ...
            options: {
                ...
                fields: () => {
                    var _a;
                    const fields = (0, data_1.mergeFields)(this.getStatisticFields(), null !== (_a = null == staticFields ? void 0 : staticFields(rawData.name)) && void 0 !== _a ? _a : []);
                    return this._seriesField && (0, data_1.mergeFields)(fields, [ {
                        key: this._seriesField,
                        operations: [ "values" ]
                    } ]), fields;
    ...
    _initExtensionMark(options) {
        ...
        this._spec.extensionMark && (null === (_a = this._spec.extensionMark) || void 0 === _a || _a.forEach(((m, i) => {
            this._createExtensionMark(m, null, `${index_1.PREFIX}_series_${this.id}_extensionMark`, i, options);
        })));
    }
    ...
    _updateExtensionMarkSpec(lastSpec) {
        ...
        null === (_a = this._spec.extensionMark) || void 0 === _a || _a.forEach(((spec, i) => {
            ...
            mark && (lastSpec && (0, vutils_1.isEqual)(null === (_a = lastSpec.extensionMark) || void 0 === _a ? void 0 : _a[i], spec) || (this.initMarkStyleWithSpec(mark, spec), 
    ...
    initTrigger() {
        ...
        this._trigger = new trigger_1.Trigger(triggerSpec, triggerOptions);
    }
    initAnimation() {}
    initMarkState() {
    ...
    initSeriesStyleState() {
        ...
        const groupBy = null !== (_a = this._seriesField) && void 0 !== _a ? _a : index_1.DEFAULT_DATA_SERIES_FIELD;
        this.getMarksWithoutRoot().forEach((mark => {
            ...
            seriesStyle.forEach((item => {
                ...
                stateValue: index_1.DEFAULT_SERIES_STYLE_NAME,
                level: -1,
            ...
            })), this.setMarkStyle(mark, style, index_1.DEFAULT_SERIES_STYLE_NAME);
        }));
    }
    afterInitMark() {
        var _a, _b, _c;
    ...
    _compareSpec(spec, prevSpec, ignoreCheckKeys) {
        ...
        return (0, vutils_1.isEqual)(currentKeys, nextKeys) ? ((ignoreCheckKeys = null != ignoreCheckKeys ? ignoreCheckKeys : {
            data: !0
        }).invalidType = !0, spec.invalidType !== prevSpec.invalidType && (result.reCompile = !0), 
        ignoreCheckKeys.extensionMark = !0, ((0, vutils_1.array)(spec.extensionMark).length !== (0, 
        vutils_1.array)(prevSpec.extensionMark).length || (null === (_a = prevSpec.extensionMark) || void 0 === _a ? void 0 : _a.some(((mark, index) => mark.type !== spec.extensionMark[index].type || mark.id !== spec.extensionMark[index].id)))) && (result.reMake = !0), 
        ...
        })) && (result.reCompile = !0), currentKeys.some((k => !ignoreCheckKeys[k] && !(0, 
        vutils_1.isEqual)(spec[k], prevSpec[k]))) ? (result.reMake = !0, result) : result)) : (result.reMake = !0, 
        result);
    }
    _updateSpecData() {
    ...
    getSeriesInfoList() {
        var _a;
        return this._getSeriesInfo(null !== (_a = this._seriesField) && void 0 !== _a ? _a : index_1.DEFAULT_DATA_SERIES_FIELD, this.getSeriesKeys());
    }
    ...
    getColorAttribute() {
        ...
        return {
            ...
            field: null !== (_b = this._seriesField) && void 0 !== _b ? _b : index_1.DEFAULT_DATA_SERIES_FIELD
        };
    }
    getDimensionField() {
        return [];
    ...
    _createMark(markInfo, option = {}) {
        ...
        if ((0, vutils_1.isValid)(m)) {
            this._marks.addMark(m, {
                name: markInfo.name
            }), isSeriesMark && (this._seriesMark = m), (0, vutils_1.isNil)(parent) ? null === (_a = this._rootMark) || void 0 === _a || _a.addMark(m) : !1 !== parent && parent.addMark(m), 
            (0, vutils_1.isNil)(dataView) ? (m.setDataView(this.getViewData(), this.getViewDataProductId()), 
            m.setSkipBeforeLayouted(!0)) : !1 !== dataView && m.setDataView(dataView, dataProductId), 
            (0, vutils_1.isBoolean)(skipBeforeLayouted) && m.setSkipBeforeLayouted(skipBeforeLayouted), 
            (0, vutils_1.isValid)(depend) && m.setDepend(...(0, vutils_1.array)(depend));
            ...
            (0, vutils_1.isNil)(progressive) || m.setProgressiveConfig(progressive), (0, vutils_1.isNil)(groupKey) || m.setGroupKey(groupKey), 
            customShape && m.setCustomizedShapeCallback(customShape), this.initMarkStyleWithSpec(m, (0, 
            merge_spec_1.mergeSpec)({}, themeSpec, markSpec || spec[m.name]));
        }
        return m;
    }
    _getDataIdKey() {
        var _a;
        return null !== (_a = super._getDataIdKey()) && void 0 !== _a ? _a : index_1.DEFAULT_DATA_KEY;
    }
    ...
    getFieldAlias(field) {
        var _a;
        return field !== index_1.STACK_FIELD_END && field !== index_1.STACK_FIELD_END_PERCENT && field !== index_1.STACK_FIELD_START && field !== index_1.STACK_FIELD_START_PERCENT || (field = this.getStackValueField()), 
        null !== (_a = (0, data_1.getFieldAlias)(this.getRawData(), field)) && void 0 !== _a ? _a : field;
    }
    getMarkInfoList() {
        var _a;
        const list = super.getMarkInfoList();
        return list.length ? list : Object.values(null !== (_a = theme_1.seriesMarkInfoMap[this.type]) && void 0 !== _a ? _a : {});
    }
