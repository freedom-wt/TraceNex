...
const vutils_1 = require("@visactor/vutils"), common_1 = require("../../typings/spec/common"), config_1 = require("../../component/common/trigger/config"), constant_1 = require("../../constant"), util_1 = require("../../util"), delayMap = {
...
class Zoomable {
    ...
    _zoomEventDispatch(params, regionOrSeries, callback) {
        ...
        (0, vutils_1.isNil)(zoomDelta) || (0, vutils_1.pointInRect)({
            x: zoomX,
            y: zoomY
    ...
    _handleDrag(params, callback, option) {
        ...
        const mouseup = delayMap[delayType]((params => {
            ...
            this._eventObj.emit("panend", {
                ...
                level: constant_1.Event_Bubble_Level.chart,
                source: constant_1.Event_Source_Type.window
            }, mouseup);
