...
function sum_default(values, valueof) {
  ...
  if (valueof == null) {
    while (++i < n) {
      if (value2 = +values[i]) sum2 += value2;
    }
  } else {
    while (++i < n) {
      if (value2 = +valueof(values[i], i, values)) sum2 += value2;
    }
  }
  return sum2;
}
...
function Sankey() {
  ...
  function initializeNodeBreadths(columns) {
    const ky2 = min_default(columns, (c) => (y1 - y0 - (c.length - 1) * py) / sum_default(c, value));
...
//# sourceMappingURL=sankeyDiagram-QLVOVGJD-SAEPPHQU.js.map
