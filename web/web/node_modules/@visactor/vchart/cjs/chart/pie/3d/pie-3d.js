...
const pie_3d_1 = require("../../../series/pie/3d/pie-3d"), type_1 = require("../../../series/interface/type"), base_1 = require("../base/base"), factory_1 = require("../../../core/factory"), base_2 = require("../base");
...
Pie3dChart.view = "singleDefault", Pie3dChart.transformerConstructor = Pie3dChartSpecTransformer;

const registerPie3dChart = () => {
    (0, pie_3d_1.registerPie3dSeries)(), factory_1.Factory.registerChart(Pie3dChart.type, Pie3dChart);
};
