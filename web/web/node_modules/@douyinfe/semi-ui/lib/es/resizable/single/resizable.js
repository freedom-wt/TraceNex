  ...
  constructor(props) {
    ...
    this.renderResizeHandler = () => {
      ...
      const handlers = directions.map(dir => {
        var _a;
        if (enable[dir] !== false) {
          return /*#__PURE__*/React.createElement(ResizableHandler, {
            key: dir,
            direction: dir,
    ...
    this.resizableRef = /*#__PURE__*/createRef();
  ...
  get adapter() {
    return Object.assign(Object.assign({}, super.adapter), {
      ...
      registerEvent: () => {
        ...
        window === null || window === void 0 ? void 0 : window.addEventListener('mouseup', this.foundation.onMouseUp);
        window === null || window === void 0 ? void 0 : window.addEventListener('mousemove', this.foundation.onMouseMove);
        window === null || window === void 0 ? void 0 : window.addEventListener('mouseleave', this.foundation.onMouseUp);
      },
      unregisterEvent: () => {
        let window = this.foundation.window;
        window === null || window === void 0 ? void 0 : window.removeEventListener('mouseup', this.foundation.onMouseUp);
        window === null || window === void 0 ? void 0 : window.removeEventListener('mousemove', this.foundation.onMouseMove);
        window === null || window === void 0 ? void 0 : window.removeEventListener('mouseleave', this.foundation.onMouseUp);
      }
    });
  }
  render() {
    ...
    }, this.getDataAttr(this.props)), this.state.isResizing && /*#__PURE__*/React.createElement("div", {
