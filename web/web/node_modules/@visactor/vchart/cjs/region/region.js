...
const vutils_1 = require("@visactor/vutils"), interface_1 = require("../compile/mark/interface"), dimension_trigger_1 = require("../interaction/dimension-trigger"), interaction_1 = require("../interaction/interaction"), constant_1 = require("../constant"), animate_manager_1 = require("../animation/animate-manager"), layout_model_1 = require("../model/layout-model"), region_transformer_1 = require("./region-transformer");
...
class Region extends layout_model_1.LayoutModel {
    ...
    constructor(spec, ctx) {
        ...
        this.layoutType = "region", this.layoutZIndex = constant_1.LayoutZIndex.Region, 
        this.interaction = new interaction_1.Interaction, this.seriesDataFilterOver = () => {
            this.event.emit(constant_1.ChartEvent.regionSeriesDataFilterOver, {
                model: this
    ...
    created() {
        ...
        this._interactionMark = this._createGroupMark("regionInteractionGroup", this.userId + "_interaction", constant_1.LayoutZIndex.Interaction), 
        this._spec.style && (this._backgroundMark = this._createMark({
            ...
            }, "normal", constant_1.AttributeLevel.Built_In), this._groupMark.addMark(mark));
        })), this._backgroundMark && this._backgroundMark.setZIndex(0), this._foregroundMark && this._foregroundMark.setZIndex(constant_1.LayoutZIndex.Mark + 1)), 
        this.createTrigger();
    }
    _createGroupMark(name, userId, zIndex) {
        ...
        return this.setMarkStyle(groupMark, {
            ...
            height: () => this.getLayoutRect().height,
            clip: clip
        }, "normal", constant_1.AttributeLevel.Built_In), this.setMarkStyle(groupMark, {
            cornerRadius: null === (_b = this._spec.style) || void 0 === _b ? void 0 : _b.cornerRadius
        }, "normal", constant_1.AttributeLevel.User_Mark), this._marks.addMark(groupMark), 
        groupMark;
    }
    init(option) {
    ...
    _initBackgroundMarkStyle() {
        ...
        }, this._spec.style), "normal", constant_1.AttributeLevel.User_Mark), (null !== (_b = this._spec.clip) && void 0 !== _b ? _b : this._getClipDefaultValue()) && this.setMarkStyle(this._backgroundMark, {
            strokeOpacity: 0
    ...
    getSeries(opt = {}) {
        return this._series.filter((s => {
            ...
            vutils_1.array)(opt.userId).includes(s.userId)) && (!(0, vutils_1.isValid)(opt.specIndex) || !s.getSpecIndex || (0, 
