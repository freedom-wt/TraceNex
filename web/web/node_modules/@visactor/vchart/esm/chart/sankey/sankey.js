...
SankeyChart.type = "sankey", SankeyChart.seriesType = SeriesTypeEnum.sankey, SankeyChart.view = "singleDefault", 
SankeyChart.transformerConstructor = SankeyChartSpecTransformer;

export const registerSankeyChart = () => {
    registerSankeySeries(), Factory.registerChart(SankeyChart.type, SankeyChart);
};
