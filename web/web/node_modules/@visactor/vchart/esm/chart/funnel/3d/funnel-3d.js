...
Funnel3dChart.view = "singleDefault", Funnel3dChart.transformerConstructor = FunnelChartSpecTransformer;

export const registerFunnel3dChart = () => {
    registerFunnel3dSeries(), Factory.registerChart(Funnel3dChart.type, Funnel3dChart);
};
