...
const data_1 = require("../chart-meta/data"), global_scale_1 = require("../../scale/global-scale"), interface_1 = require("../../component/interface"), factory_1 = require("../../core/factory"), event_1 = require("../../event/event"), util_1 = require("../../util"), stack_1 = require("../stack"), base_model_1 = require("../../model/base-model"), base_mark_1 = require("../../mark/base/base-mark"), base_1 = require("../../constant/base"), vutils_1 = require("@visactor/vutils"), util_2 = require("../../theme/color-scheme/util"), compilable_base_1 = require("../../compile/compilable-base"), interface_2 = require("../../compile/mark/interface"), constant_1 = require("../../constant"), dimension_1 = require("../../event/events/dimension"), util_3 = require("../util"), vscale_1 = require("@visactor/vscale"), initialize_1 = require("../../data/initialize");
...
class BaseChart extends compilable_base_1.CompilableBase {
    ...
    _createBackground() {
        ...
        backgroundStyle && (this._backgroundMark = factory_1.Factory.createMark("group", "chart-background", {
            model: this,
