...
class BarSeries extends cartesian_1.CartesianSeries {
    ...
    _getBarWidth(axisHelper) {
        ...
        if (hasBarWidth) return (0, space_1.getActualNumValue)(this._spec.barWidth, bandWidth);
        const hasBarMinWidth = void 0 !== this._spec.barMinWidth, hasBarMaxWidth = void 0 !== this._spec.barMaxWidth;
        let width = bandWidth;
        return hasBarMinWidth && (width = Math.max(width, (0, space_1.getActualNumValue)(this._spec.barMinWidth, bandWidth))), 
    ...
    _getPosition(direction, datum) {
        ...
        vutils_1.isValid)(this._spec.barGapInGroup)) {
            ...
            for (let index = groupFields.length - 1; index >= 1; index--) {
                ...
                space_1.getActualNumValue)(null !== (_j = barInGroup[index - 1]) && void 0 !== _j ? _j : (0, 
...
exports.BarSeries = BarSeries, BarSeries.type = type_1.SeriesTypeEnum.bar, BarSeries.mark = constant_2.barSeriesMark, 
