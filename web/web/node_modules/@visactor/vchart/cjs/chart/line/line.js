...
class LineChart extends base_1.BaseChart {
    constructor() {
        ...
        this.type = "line", this.seriesType = type_1.SeriesTypeEnum.line, this._canStack = !0;
    }
}

exports.LineChart = LineChart, LineChart.type = "line", LineChart.seriesType = type_1.SeriesTypeEnum.line, 
LineChart.view = "singleDefault", LineChart.transformerConstructor = line_transformer_1.LineChartSpecTransformer;
