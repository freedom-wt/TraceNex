...
const base_chart_1 = require("../base/base-chart"), factory_1 = require("../../core/factory"), common_transformer_1 = require("./common-transformer");
...
class CommonChart extends base_chart_1.BaseChart {
    constructor() {
        ...
        this.type = "common", this._canStack = !0;
    }
}

exports.CommonChart = CommonChart, CommonChart.type = "common", CommonChart.view = "singleDefault", 
CommonChart.transformerConstructor = common_transformer_1.CommonChartSpecTransformer;
