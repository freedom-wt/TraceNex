...
const vutils_1 = require("@visactor/vutils"), type_1 = require("../../interface/type"), data_filter_base_component_1 = require("../data-filter-base-component"), vrender_components_1 = require("@visactor/vrender-components"), style_1 = require("../../../util/style"), constant_1 = require("../../../constant"), scroll_bar_1 = require("../../../constant/scroll-bar"), factory_1 = require("../../../core/factory");
...
class ScrollBar extends data_filter_base_component_1.DataFilterBaseComponent {
    static getSpecInfo(chartSpec) {
        ...
        if (!(0, vutils_1.isArray)(compSpec)) return [ {
            ...
            type: type_1.ComponentTypeEnum.scrollBar
        } ];
        const specInfos = [];
    ...
    constructor(spec, options) {
        ...
        this.specKey = "scrollBar", this.layoutZIndex = constant_1.LayoutZIndex.DataZoom, 
        this.layoutLevel = constant_1.LayoutLevel.DataZoom, this.layoutType = "region-relative", 
    ...
    _createOrUpdateComponent() {
        ...
        if (this._component) this._component.setAttributes(attrs); else {
            ...
            this._component = new vrender_components_1.ScrollBar(attrs), this._component.addEventListener("scroll", (e => {
    ...
    _handleChange(start, end, updateComponent) {
        super._handleChange(start, end, updateComponent), updateComponent && this._component && this._component.setAttribute("range", [ start, end ]), 
    ...
    _initCommonEvent() {
        super._initCommonEvent(), this._component && this._component.on("scroll", (e => {
            const value = e.detail.value;
            this._handleChange(value[0], value[1]);
        }));
    }
