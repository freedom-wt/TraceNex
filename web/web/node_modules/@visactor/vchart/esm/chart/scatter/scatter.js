...
export class ScatterChart extends BaseChart {
    constructor() {
        ...
        this.type = "scatter", this.seriesType = SeriesTypeEnum.scatter, this._canStack = !0;
    }
}

ScatterChart.type = "scatter", ScatterChart.seriesType = SeriesTypeEnum.scatter, 
ScatterChart.view = "singleDefault", ScatterChart.transformerConstructor = ScatterChartSpecTransformer;
