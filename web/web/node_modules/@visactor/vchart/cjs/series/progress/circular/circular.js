...
const vutils_1 = require("@visactor/vutils"), type_1 = require("../../interface/type"), utils_1 = require("../../../animation/utils"), progress_like_1 = require("../../polar/progress-like/progress-like"), arc_1 = require("../../../mark/arc"), progress_arc_1 = require("../../../mark/progress-arc"), constant_1 = require("./constant"), constant_2 = require("../../../constant"), factory_1 = require("../../../core/factory"), progress_like_2 = require("../../polar/progress-like"), config_1 = require("../../../animation/config");

class CircularProgressSeries extends progress_like_1.ProgressLikeSeries {
    constructor() {
        super(...arguments), this.type = type_1.SeriesTypeEnum.circularProgress, this._progressMark = null, 
        this._trackMark = null, this._getRadiusValueStart = datum => {
    ...
    _initProgressMarkStyle() {
        ...
        progressMark && (this.setMarkStyle(progressMark, {
            ...
            zIndex: 200,
            forceShowCap: !0
        }, "normal", constant_2.AttributeLevel.Series), this._trigger.registerMark(progressMark));
    }
    initTooltip() {
    ...
    _initTrackMarkStyle() {
        ...
        trackMark && (this.setMarkStyle(trackMark, {
            ...
            y: () => this.angleAxisHelper.center().y,
            startAngle: () => {
                const fieldName = this._stack ? constant_2.STACK_FIELD_START : this._angleField[0], domain = this.angleAxisHelper.getScale(0).domain();
                return this._getAngleValueStart({
                    [fieldName]: domain[0]
                });
            },
            endAngle: () => {
                const fieldName = this._stack ? constant_2.STACK_FIELD_END : this._angleField[0], domain = this.angleAxisHelper.getScale(0).domain();
            ...
            fill: this.getColorAttribute(),
            zIndex: 100
        }, "normal", constant_2.AttributeLevel.Series), this._trigger.registerMark(trackMark));
    }
    initAnimation() {
        var _a, _b, _c, _d;
...
CircularProgressSeries.mark = constant_1.circularProgressSeriesMark;

const registerCircularProgressSeries = () => {
    (0, progress_arc_1.registerProgressArcMark)(), (0, arc_1.registerArcMark)(), (0, 
    progress_like_2.registerProgressLikeAnimation)(), (0, config_1.registerFadeInOutAnimation)(), 
