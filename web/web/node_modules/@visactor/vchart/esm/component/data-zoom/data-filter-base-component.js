...
export class DataFilterBaseComponent extends BaseComponent {
    ...
    _initData() {
        ...
        if (this._relatedAxisComponent) {
            ...
            eachSeries(this._regions, (s => {
                ...
                const seriesSpec = s.getSpec(), xFields = array(seriesSpec.xField), yFields = array(seriesSpec.yField), xField = "cartesian" === s.coordinate ? xFields[0] : null !== (_a = seriesSpec.angleField) && void 0 !== _a ? _a : seriesSpec.categoryField, yField = "cartesian" === s.coordinate ? yFields[0] : null !== (_b = seriesSpec.radiusField) && void 0 !== _b ? _b : seriesSpec.valueField;
        ...
        } else hasValidateValueField = isNil(this._spec.valueField), eachSeries(this._regions, (s => {
    ...
    _setStateFromSpec() {
        ...
        this._maxSpan = null !== (_b = this._spec.maxSpan) && void 0 !== _b ? _b : 1, isContinuous(this._stateScale.type) && this._stateScale.domain[0] !== this._stateScale.domain[1] && (this._spec.minValueSpan && (this._minSpan = this._spec.minValueSpan / (this._stateScale.domain()[1] - this._stateScale.domain()[0])), 
