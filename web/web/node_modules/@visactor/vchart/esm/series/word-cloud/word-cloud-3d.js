...
export class WordCloud3dSeries extends BaseWordCloudSeries {
    ...
    initAnimation() {
        ...
        })), userAnimationConfig("word", this._spec, this._markAttributeContext))), this._fillingWordMark && this._fillingWordMark.setAnimationConfig(animationConfig(null === (_c = Factory.getAnimationInKey("wordCloud3d")) || void 0 === _c ? void 0 : _c((() => {
            var _a;
            const srView = this.getCompiler().getVGrammarView(), width = srView.width() - padding.left || 0 - padding.right || 0, height = srView.height() - padding.top || 0 - padding.bottom || 0, r = Math.max(width, height) / 2;
            return {
                center: {
