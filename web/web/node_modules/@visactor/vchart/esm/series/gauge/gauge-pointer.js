...
export class GaugePointerSeries extends ProgressLikeSeries {
    constructor() {
        super(...arguments), this.type = SeriesTypeEnum.gaugePointer, this._pinMark = null, 
...
export const registerGaugePointerSeries = () => {
    registerPathMark(), registerRectMark(), registerGaugePointerAnimation(), Factory.registerSeries(GaugePointerSeries.type, GaugePointerSeries);
};
