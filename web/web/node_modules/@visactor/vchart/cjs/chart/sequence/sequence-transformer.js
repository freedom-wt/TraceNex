...
class SequenceChartSpecTransformer extends base_1.BaseChartSpecTransformer {
    ...
    transformSpec(spec) {
        ...
        rowHeight.push({
            ...
            col: 1,
            row: rowNum
        }), spec.axes[0].id = `axesRow${rowNum}`, spec.axes[0].regionIndex = Array.from(Array(spec.series.length), ((_, index) => index + 1)), 
