...
export class WordCloudChart extends BaseWordCloudChart {
    constructor() {
        super(...arguments), this.transformerConstructor = WordCloudChartSpecTransformer, 
...
WordCloudChart.view = "singleDefault", WordCloudChart.transformerConstructor = WordCloudChartSpecTransformer;
