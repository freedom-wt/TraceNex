...
class DotSeries extends cartesian_1.CartesianSeries {
    ...
    setSeriesField(field) {
        (0, vutils_1.isValid)(field) && (this._seriesField = field, this.getMarksInType([ "line", "area" ]).forEach((m => {
    ...
    setAttrFromSpec() {
        ...
        this.setGridBackground((0, merge_spec_1.mergeSpec)(config_1.DEFAULT_GRID_BACKGROUND, (null === (_a = this._spec.grid) || void 0 === _a ? void 0 : _a.background) || {}));
    }
    initMark() {
    ...
    initMarkStyle() {
        ...
        }, "normal", index_1.AttributeLevel.Series), this._trigger.registerMark(gridBackgroundMark));
        ...
        }, "normal", index_1.AttributeLevel.Series), this._trigger.registerMark(gridMark));
        ...
        }, "normal", index_1.AttributeLevel.Series), this._trigger.registerMark(dotMark));
        ...
        titleMark && (this.setMarkStyle(titleMark, {
            ...
            x: this.getRegionRectLeft.bind(this),
            y: this.dataToPositionY.bind(this)
        }, "normal", index_1.AttributeLevel.Series), this._trigger.registerMark(titleMark));
        ...
        subTitleMark && (this.setMarkStyle(subTitleMark, {
            ...
            x: this.getRegionRectLeft.bind(this),
            y: this.dataToPositionY.bind(this)
        }, "normal", index_1.AttributeLevel.Series), this._trigger.registerMark(subTitleMark));
        const symbolMark = this._symbolMark;
        symbolMark && (this.setMarkStyle(symbolMark, {
            x: this.getRegionRectLeft.bind(this),
            y: this.dataToPositionY.bind(this),
            fill: this.getColorAttribute()
        }, "normal", index_1.AttributeLevel.Series), this._trigger.registerMark(symbolMark));
    }
    ...
    getColorAttribute() {
        ...
        return {
            ...
            field: null !== (_c = null !== (_b = this._seriesGroupField) && void 0 !== _b ? _b : this._seriesField) && void 0 !== _c ? _c : index_1.DEFAULT_DATA_SERIES_FIELD
        };
    }
    getDotColorScale() {
        var _a, _b, _c;
    ...
    getDotColorAttribute() {
        ...
        return {
            ...
            field: null !== (_d = null !== (_c = null !== (_b = this._dotTypeField) && void 0 !== _b ? _b : this._seriesGroupField) && void 0 !== _c ? _c : this._seriesField) && void 0 !== _d ? _d : index_1.DEFAULT_DATA_SERIES_FIELD
        };
    }
    initTooltip() {
