...
class BarChart extends base_1.BaseChart {
    constructor() {
        ...
        this.type = "bar", this.seriesType = type_1.SeriesTypeEnum.bar, this._canStack = !0;
    }
}

exports.BarChart = BarChart, BarChart.type = "bar", BarChart.seriesType = type_1.SeriesTypeEnum.bar, 
BarChart.view = "singleDefault", BarChart.transformerConstructor = bar_transformer_1.BarChartSpecTransformer;
