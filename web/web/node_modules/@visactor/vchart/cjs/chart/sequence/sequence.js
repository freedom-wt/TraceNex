...
const link_1 = require("../../series/link/link"), dot_1 = require("../../series/dot/dot"), base_chart_1 = require("../base/base-chart"), factory_1 = require("../../core/factory"), type_1 = require("../../series/interface/type"), sequence_transformer_1 = require("./sequence-transformer");
...
exports.SequenceChart = SequenceChart, SequenceChart.type = "sequence", SequenceChart.view = "singleDefault", 
SequenceChart.transformerConstructor = sequence_transformer_1.SequenceChartSpecTransformer;

const registerSequenceChart = () => {
    (0, dot_1.registerDotSeries)(), (0, link_1.registerLinkSeries)(), factory_1.Factory.registerChart(SequenceChart.type, SequenceChart);
};
