...
Bar3dChart.type = "bar3d", Bar3dChart.seriesType = SeriesTypeEnum.bar3d, Bar3dChart.view = "singleDefault", 
Bar3dChart.transformerConstructor = Bar3dChartSpecTransformer;

export const registerBar3dChart = () => {
    registerBar3dSeries(), Factory.registerChart(Bar3dChart.type, Bar3dChart);
};
