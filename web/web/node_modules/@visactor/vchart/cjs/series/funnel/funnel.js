...
const type_1 = require("../interface/type"), base_series_1 = require("../base/base-series"), constant_1 = require("../../constant"), register_1 = require("../../data/register"), vdataset_1 = require("@visactor/vdataset"), funnel_1 = require("../../data/transforms/funnel"), funnel_2 = require("../../constant/funnel"), space_1 = require("../../util/space"), object_1 = require("../../util/object"), tooltip_helper_1 = require("./tooltip-helper"), vutils_1 = require("@visactor/vutils"), config_1 = require("../../animation/config"), utils_1 = require("../../animation/utils"), series_data_1 = require("../base/series-data"), polygon_1 = require("../../mark/polygon/polygon"), text_1 = require("../../mark/text"), rule_1 = require("../../mark/rule"), constant_2 = require("./constant"), factory_1 = require("../../core/factory"), funnel_transformer_1 = require("./funnel-transformer");
...
class FunnelSeries extends base_series_1.BaseSeries {
    ...
    initData() {
        ...
        const viewDataTransform = new vdataset_1.DataView(this._dataSet, {
            name: `${constant_1.PREFIX}_series_${this.id}_viewDataTransform`
        });
        viewDataTransform.parse([ this.getViewData() ], {
            type: "dataview"
        }), this._viewDataTransform = new series_data_1.SeriesData(this._option, viewDataTransform);
    }
    getStatisticFields() {
        const fields = [];
        return fields.push({
    ...
    initMarkStyle() {
        ...
        }, "normal", constant_1.AttributeLevel.Series), this._trigger.registerMark(funnelMark));
        const funnelTransformMark = this._funnelTransformMark;
        funnelTransformMark && (this.setMarkStyle(funnelTransformMark, {
            points: datum => this.getPoints(datum)
        }, "normal", constant_1.AttributeLevel.Series), this._trigger.registerMark(funnelTransformMark));
        ...
        outerLabelMark && this.setMarkStyle(outerLabelMark, {
            text: datum => {
                ...
                return (0, vutils_1.isFunction)(this._spec.outerLabel.formatMethod) ? this._spec.outerLabel.formatMethod(text, datum) : text;
            },
    ...
    initLabelMarkStyle(labelMark) {
        ...
        }, "normal", constant_1.AttributeLevel.Series), (null === (_a = this._funnelOuterLabelMark) || void 0 === _a ? void 0 : _a.label) && this._funnelOuterLabelMark.label.setDepend(component), 
    ...
    _getPositionByData(datum) {
        var _a;
        const index = null === (_a = this.getViewData().latestData) || void 0 === _a ? void 0 : _a.findIndex((d => d[this._categoryField] === datum[this._categoryField] && d[constant_1.DEFAULT_DATA_KEY] === datum[constant_1.DEFAULT_DATA_KEY]));
    ...
    _computeOuterLabelLimit(datum) {
        ...
        return this.getLayoutRect().width / 2 - Math.max(shapeMiddleWidth / 2, funnelLabelWidth / 2) - funnel_2.FUNNEL_LABEL_LINE_LENGTH - 2 * (null !== (_e = null === (_d = this._spec.outerLabel) || void 0 === _d ? void 0 : _d.spaceWidth) && void 0 !== _e ? _e : funnel_2.FUNNEL_LABEL_SPACE_WIDTH);
    }
    _computeOuterLabelLinePosition(datum) {
        ...
        let x1, x2, y1, y2;
        if (this._isHorizontal()) {
            const spaceWidth = null !== (_k = outerLabelSpec.spaceWidth) && void 0 !== _k ? _k : funnel_2.FUNNEL_LABEL_SPACE_WIDTH, points = this.getPoints(datum), shapeMiddleHeight = (Math.abs(points[0].y - points[1].y) + Math.abs(points[2].y - points[3].y)) / 2;
            ...
            x1 = this._getPolygonCenter(points).x, y1 - y2 < funnel_2.FUNNEL_LABEL_LINE_LENGTH && (y2 = y1 - funnel_2.FUNNEL_LABEL_LINE_LENGTH), 
            ...
            x1 = this._getPolygonCenter(points).x, y2 - y1 < funnel_2.FUNNEL_LABEL_LINE_LENGTH && (y2 = y1 + funnel_2.FUNNEL_LABEL_LINE_LENGTH), 
            x2 = x1), {
                x1: x1,
                x2: x2,
                y1: y1,
        ...
        const points = this.getPoints(datum), shapeMiddleWidth = (Math.abs(points[0].x - points[1].x) + Math.abs(points[2].x - points[3].x)) / 2, labelWidth = (null == labelMarkBounds ? void 0 : labelMarkBounds.x2) - (null == labelMarkBounds ? void 0 : labelMarkBounds.x1) || 0, spaceWidth = null !== (_l = outerLabelSpec.spaceWidth) && void 0 !== _l ? _l : funnel_2.FUNNEL_LABEL_SPACE_WIDTH;
        ...
        y1 = this._getPolygonCenter(points).y, x2 - x1 < funnel_2.FUNNEL_LABEL_LINE_LENGTH && (x2 = x1 + funnel_2.FUNNEL_LABEL_LINE_LENGTH), 
        ...
        y1 = this._getPolygonCenter(points).y, x1 - x2 < funnel_2.FUNNEL_LABEL_LINE_LENGTH && (x2 = x1 - funnel_2.FUNNEL_LABEL_LINE_LENGTH), 
        y2 = y1), {
            x1: x1,
            x2: x2,
            y1: y1,
...
FunnelSeries.mark = constant_2.funnelSeriesMark, FunnelSeries.transformerConstructor = funnel_transformer_1.FunnelSeriesSpecTransformer;
