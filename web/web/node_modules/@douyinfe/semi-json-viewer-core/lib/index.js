...
var FoldingModel = class {
  ...
  updateCollapsedRanges() {
    const newCollapsedRanges = /* @__PURE__ */ new Map();
  ...
  getVisibleLineNumber(actualLineNumber) {
...
var View = class {
  ...
  createLineScrollContainerElement() {
  ...
  createLineContentElement(lineContent, actualLineNumber, visibleLineNumber) {
    const rowDatum = this._scalingCellSizeAndPositionManager.getSizeAndPositionOfCell(visibleLineNumber);
  ...
  highlightContent(content, offset, searchResults, tokenClass) {
    let result = "";
    let lastIndex = 0;
    for (const match of searchResults) {
      ...
      if (match.range.startLineNumber === currentMatch?.range.startLineNumber && match.range.endLineNumber === currentMatch?.range.endLineNumber && match.range.startColumn === currentMatch?.range.startColumn && match.range.endColumn === currentMatch?.range.endColumn) {
