...
class Label extends base_label_1.BaseLabelComponent {
    constructor(spec, options) {
        ...
        this.layoutZIndex = constant_1.LayoutZIndex.Label, this._layoutRule = spec.labelLayout || "series";
    }
    ...
    initEvent() {
        this.event.on(constant_1.ChartEvent.dataZoomChange, (() => {
            ...
            })), this.event.on(constant_1.VGRAMMAR_HOOK_EVENT.AFTER_MARK_RENDER_END, enableAnimation);
        }));
    ...
    _initTextMarkStyle() {
        this._labelInfoMap.forEach((labelInfos => {
            labelInfos.forEach((info => {
                ...
                (null === (_b = null === (_a = labelMark.stateStyle) || void 0 === _a ? void 0 : _a.normal) || void 0 === _b ? void 0 : _b.lineWidth) && labelMark.setAttribute("stroke", series.getColorAttribute(), "normal", constant_1.AttributeLevel.Base_Series);
            }));
        }));
    }
    ...
    _updateLabelComponentAttribute(component, target, labelInfos) {
        ...
        component.target(target).configure({
            ...
            if (labelInfo) {
                const {labelSpec: labelSpec, labelMark: labelMark} = labelInfo, rule = labelMark.getRule(), interactive = this._interactiveConfig(labelSpec), centerOffset = null !== (_b = null === (_a = this._spec) || void 0 === _a ? void 0 : _a.centerOffset) && void 0 !== _b ? _b : 0, spec = (0, 
                merge_spec_1.mergeSpec)({
                ...
                vutils_1.pickWithout)(labelSpec, [ "position", "style", "state", "type" ])), interactive), {
