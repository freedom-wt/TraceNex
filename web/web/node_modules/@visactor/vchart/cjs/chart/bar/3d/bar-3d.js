...
const bar_3d_1 = require("../../../series/bar/bar-3d"), type_1 = require("../../../series/interface/type"), factory_1 = require("../../../core/factory"), bar_1 = require("../bar"), bar_3d_transformer_1 = require("./bar-3d-transformer");
...
Bar3dChart.view = "singleDefault", Bar3dChart.transformerConstructor = bar_3d_transformer_1.Bar3dChartSpecTransformer;

const registerBar3dChart = () => {
    (0, bar_3d_1.registerBar3dSeries)(), factory_1.Factory.registerChart(Bar3dChart.type, Bar3dChart);
};
