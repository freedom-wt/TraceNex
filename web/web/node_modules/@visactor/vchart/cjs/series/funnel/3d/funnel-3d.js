...
const constant_1 = require("../../../constant"), type_1 = require("../../interface/type"), funnel_1 = require("../funnel"), pyramid_3d_1 = require("../../../mark/polygon/pyramid-3d"), text_1 = require("../../../mark/text"), rule_1 = require("../../../mark/rule"), constant_2 = require("../constant"), factory_1 = require("../../../core/factory"), funnel_3d_transformer_1 = require("./funnel-3d-transformer");
...
class Funnel3dSeries extends funnel_1.FunnelSeries {
    ...
    initLabelMarkStyle(labelMark) {
        ...
        }, "normal", constant_1.AttributeLevel.Series), this._labelMark = labelMark, (null === (_a = this._funnelOuterLabelMark) || void 0 === _a ? void 0 : _a.label) && this._funnelOuterLabelMark.label.setDepend(labelMark.getComponent()), 
...
Funnel3dSeries.mark = constant_2.funnel3dSeriesMark, Funnel3dSeries.transformerConstructor = funnel_3d_transformer_1.Funnel3dSeriesSpecTransformer;
