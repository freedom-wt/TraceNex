...
const type_1 = require("../../interface/type"), range_column_1 = require("../range-column"), rect_3d_1 = require("../../../mark/rect-3d"), constant_1 = require("../constant"), factory_1 = require("../../../core/factory");
...
const registerRangeColumn3dSeries = () => {
    (0, rect_3d_1.registerRect3dMark)(), factory_1.Factory.registerSeries(RangeColumn3dSeries.type, RangeColumn3dSeries);
};
