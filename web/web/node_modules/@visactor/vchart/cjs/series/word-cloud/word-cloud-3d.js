...
class WordCloud3dSeries extends base_1.BaseWordCloudSeries {
    ...
    initMark() {
        this._wordMark = this._createMark(base_1.BaseWordCloudSeries.mark.word, {
            ...
            support3d: !0,
            isSeriesMark: !0
        }), this._isWordCloudShape && (this._fillingWordMark = this._createMark(base_1.BaseWordCloudSeries.mark.fillingWord, {
            groupKey: this._seriesField,
            support3d: !0,
            isSeriesMark: !0
        }));
    ...
    initAnimation() {
        ...
        })), (0, utils_1.userAnimationConfig)("fillingWord", this._spec, this._markAttributeContext)));
    }
}
