...
const vutils_1 = require("@visactor/vutils"), line_mixin_1 = require("../mixin/line-mixin"), cartesian_1 = require("../cartesian/cartesian"), constant_1 = require("../../constant"), scale_1 = require("../../util/scale"), type_1 = require("../interface/type"), vutils_2 = require("@visactor/vutils"), utils_1 = require("../../animation/utils"), interpolate_1 = require("../../typings/interpolate"), line_1 = require("../../mark/line"), area_1 = require("../../mark/area"), symbol_1 = require("../../mark/symbol"), tooltip_helpter_1 = require("./tooltip-helpter"), constant_2 = require("./constant"), factory_1 = require("../../core/factory"), animation_1 = require("./animation"), vgrammar_core_1 = require("@visactor/vgrammar-core"), area_transformer_1 = require("./area-transformer"), utils_2 = require("../util/utils");
...
class AreaSeries extends cartesian_1.CartesianSeries {
    ...
    initTooltip() {
        this._tooltipHelper = new tooltip_helpter_1.AreaSeriesTooltipHelper(this), this._areaMark && this._tooltipHelper.activeTriggerSet.dimension.add(this._areaMark), 
...
exports.AreaSeries = AreaSeries, AreaSeries.type = type_1.SeriesTypeEnum.area, AreaSeries.mark = constant_2.areaSeriesMark, 
AreaSeries.transformerConstructor = area_transformer_1.AreaSeriesSpecTransformer, 
(0, vutils_2.mixin)(AreaSeries, line_mixin_1.LineLikeSeriesMixin);

const registerAreaSeries = () => {
    (0, vgrammar_core_1.registerSampleTransform)(), (0, vgrammar_core_1.registerMarkOverlapTransform)(), 
    (0, line_1.registerLineMark)(), (0, area_1.registerAreaMark)(), (0, symbol_1.registerSymbolMark)(), 
    (0, animation_1.registerAreaAnimation)(), factory_1.Factory.registerSeries(AreaSeries.type, AreaSeries);
};
