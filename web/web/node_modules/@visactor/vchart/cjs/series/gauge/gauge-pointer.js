...
const vutils_1 = require("@visactor/vutils"), type_1 = require("../interface/type"), utils_1 = require("../../animation/utils"), progress_like_1 = require("../polar/progress-like"), path_1 = require("../../mark/path"), rect_1 = require("../../mark/rect"), constant_1 = require("./constant"), factory_1 = require("../../core/factory"), animation_1 = require("./animation");

class GaugePointerSeries extends progress_like_1.ProgressLikeSeries {
    constructor() {
        super(...arguments), this.type = type_1.SeriesTypeEnum.gaugePointer, this._pinMark = null, 
        this._pointerMark = null, this._pinBackgroundMark = null, this._stack = !1;
    }
    setAttrFromSpec() {
        var _a;
...
GaugePointerSeries.mark = constant_1.gaugePointerSeriesMark;

const registerGaugePointerSeries = () => {
    (0, path_1.registerPathMark)(), (0, rect_1.registerRectMark)(), (0, animation_1.registerGaugePointerAnimation)(), 
    factory_1.Factory.registerSeries(GaugePointerSeries.type, GaugePointerSeries);
};
