...
const vutils_1 = require("@visactor/vutils"), vgrammar_projection_1 = require("@visactor/vgrammar-projection"), vdataset_1 = require("@visactor/vdataset"), geo_source_1 = require("./geo-source"), lookup_1 = require("../../data/transforms/lookup"), geo_1 = require("../geo/geo"), map_1 = require("../../data/transforms/map"), copy_data_view_1 = require("../../data/transforms/copy-data-view"), register_1 = require("../../data/register"), tooltip_helper_1 = require("./tooltip-helper"), index_1 = require("../../constant/index"), type_1 = require("../interface/type"), series_data_1 = require("../base/series-data"), utils_1 = require("../../animation/utils"), config_1 = require("../../animation/config"), path_1 = require("../../mark/path"), constant_1 = require("./constant"), factory_1 = require("../../core/factory"), geo_2 = require("../../component/geo"), initialize_1 = require("../../data/initialize"), map_transformer_1 = require("./map-transformer");
...
class MapSeries extends geo_1.GeoSeries {
    ...
    initData() {
        ...
        this._mapViewData = new series_data_1.SeriesData(this._option, mapData);
    }
    initMark() {
    ...
    initMarkStyle() {
        ...
        pathMark && (this.setMarkStyle(pathMark, {
            fill: datum => {
                var _a, _b, _c, _d;
                return (0, vutils_1.isValid)(datum[null !== (_a = this._seriesField) && void 0 !== _a ? _a : index_1.DEFAULT_DATA_SERIES_FIELD]) ? (null !== (_b = this._option.globalScale.getScale("color")) && void 0 !== _b ? _b : this._getDefaultColorScale()).scale(datum[null !== (_c = this._seriesField) && void 0 !== _c ? _c : index_1.DEFAULT_DATA_SERIES_FIELD]) : null === (_d = this._spec) || void 0 === _d ? void 0 : _d.defaultFillColor;
            },
    ...
    getPath(datum) {
        var _a;
        const area = this._areaCache.get(datum[index_1.DEFAULT_DATA_INDEX]);
        if (area) return area.shape;
        const shape = null === (_a = this._coordinateHelper) || void 0 === _a ? void 0 : _a.shape(datum);
        return this._areaCache.set(datum[index_1.DEFAULT_DATA_INDEX], {
            shape: shape
        }), shape;
    }
    onEvaluateEnd() {
    ...
    _getDataIdKey() {
        return index_1.DEFAULT_DATA_INDEX;
    }
    getActiveMarks() {
...
const registerMapSeries = () => {
    (0, vgrammar_projection_1.registerProjection)(), (0, geo_2.registerGeoCoordinate)(), 
    (0, path_1.registerPathMark)(), factory_1.Factory.registerSeries(MapSeries.type, MapSeries), 
