...
const util_1 = require("../../../util"), vscale_1 = require("@visactor/vscale"), factory_1 = require("../../../core/factory"), common_1 = require("./util/common"), constant_1 = require("../../../constant"), index_1 = require("../../../constant/index"), components_1 = __importDefault(require("../../../plugin/components")), type_1 = require("../../interface/type"), vgrammar_core_1 = require("@visactor/vgrammar-core"), util_2 = require("../util"), compilable_data_1 = require("../../../compile/data/compilable-data"), base_axis_1 = require("../base-axis"), vrender_core_1 = require("@visactor/vrender-core"), CartesianAxisPlugin = [ components_1.default.AxisSyncPlugin ];
...
class CartesianAxis extends base_axis_1.AxisComponent {
    ...
    constructor(spec, options) {
        ...
        this.layoutType = "region-relative", this.layoutZIndex = constant_1.LayoutZIndex.Axis, 
        this.layoutLevel = index_1.LayoutLevel.Axis, this._orient = "left", this._autoIndentOnce = !1, 
        this._hasAutoIndent = !1, this._scales = [], this._tick = void 0, this._layoutCache = {
            ...
            scaleUpdate: params => {
                this.computeData(null == params ? void 0 : params.value), (0, util_1.eachSeries)(this._regions, (s => {
                    ...
                    (0, common_1.isXAxis)(orient) ? s.setXAxisHelper(this.axisHelper()) : (0, common_1.isYAxis)(orient) ? s.setYAxisHelper(this.axisHelper()) : (0, 
                    common_1.isZAxis)(orient) && s.setZAxisHelper(this.axisHelper());
                }), {
            ...
            switch (this._layout.layoutOrient) {
              case "left":
                this._layout.layoutRectLevelMap.width === constant_1.DEFAULT_LAYOUT_RECT_LEVEL && (result.width = bounds.x1 < 0 ? -bounds.x1 : 0);
                break;

              case "right":
                this._layout.layoutRectLevelMap.width === constant_1.DEFAULT_LAYOUT_RECT_LEVEL && (result.width = bounds.x2 > 0 ? bounds.x2 : 0);
                break;

              case "top":
                this._layout.layoutRectLevelMap.height === constant_1.DEFAULT_LAYOUT_RECT_LEVEL && (result.height = bounds.y1 < 0 ? -bounds.y1 : 0);
                break;

              case "bottom":
                this._layout.layoutRectLevelMap.height === constant_1.DEFAULT_LAYOUT_RECT_LEVEL && (result.height = bounds.y2 > 0 ? bounds.y2 : 0);
            }
            ...
            if (this.visible && onZero && !1 !== visible) {
                ...
                common_1.isXAxis)(this.getOrient()), isValidAxis = item => {
                    ...
                    vscale_1.isContinuous)(item.getScale().type) && item.getTickData() ? null === (_a = item.getTickData().getLatestData()) || void 0 === _a ? void 0 : _a.find((d => 0 === d.value)) : item.getScale().ticks().includes(0);
    ...
    updateScaleRange() {
        ...
        let newRange = [];
        (0, common_1.isXAxis)(this.getOrient()) ? (0, util_1.isValidNumber)(width) && (newRange = this._inverse ? [ width - right, left ] : [ left, width - right ]) : (0, 
    ...
    onLayoutStart(layoutRect, viewRect, ctx) {
        if (super.onLayoutStart(layoutRect, viewRect, ctx), !(0, common_1.isZAxis)(this.getOrient()) && this._spec.innerOffset) {
    ...
    afterCompile() {
        ...
        product && product.addEventListener(vgrammar_core_1.HOOK_EVENT.AFTER_ELEMENT_ENCODE, (() => {
            if (!1 === this._isLayout && ((0, common_1.isXAxis)(this.getOrient()) ? this.callPlugin((plugin => {
                ...
                const bounds = product.graphicItem.AABBBounds, pos = (0, common_1.isXAxis)(this._orient) ? {
                    x: bounds.x2,
    ...
    onLayoutEnd(ctx) {
        this.updateScaleRange() ? this.event.emit(constant_1.ChartEvent.scaleUpdate, {
            model: this,
            value: "range"
    ...
    collectData(depth, rawData) {
        ...
        return (0, util_1.eachSeries)(this._regions, (s => {
            var _a, _b, _c;
            let field;
            if (field = depth > 0 ? null === (_b = null === (_a = s.getGroups()) || void 0 === _a ? void 0 : _a.fields) || void 0 === _b ? void 0 : _b[depth] : (0, 
            common_1.isXAxis)(this.getOrient()) ? s.fieldX2 ? [ ...s.fieldX, s.fieldX2 ] : s.fieldX : (0, 
            common_1.isZAxis)(this.getOrient()) ? s.fieldZ : s.fieldY, field = (0, util_1.isArray)(field) ? (0, 
            vscale_1.isContinuous)(this._scale.type) ? field : [ field[0] ] : [ field ], depth || (this._dataFieldText = s.getFieldAlias(field[0])), 
            field) {
    ...
    updateSeriesScale() {
        ...
        (0, util_1.eachSeries)(this._regions, (s => {
            (0, common_1.isXAxis)(orient) ? (s.setScaleX(this._scale), s.setXAxisHelper(this.axisHelper())) : (0, 
            common_1.isYAxis)(orient) ? (s.setScaleY(this._scale), s.setYAxisHelper(this.axisHelper())) : (0, 
            common_1.isZAxis)(orient) && (s.setScaleZ(this._scale), s.setZAxisHelper(this.axisHelper()));
        }), {
            userId: this._seriesUserId,
            specIndex: this._seriesIndex
        });
    ...
    getBoundsInRect(rect) {
        ...
        !this.updateScaleRange() && (0, util_1.isArray)(this._tickData.getLatestData()) || this.computeData("range");
        const context = {
            skipLayout: !1
        ...
        if (!context.skipLayout) {
            const attrs = this._getUpdateAttribute(!0), axisComponent = product.getGroupGraphicItem(), spec = (0, 
            util_1.mergeSpec)(Object.assign({}, this.getLayoutStartPoint()), this._axisStyle, attrs, {
                line: {
                    visible: !1
                }
    ...
    updateLayoutAttribute() {
        ...
        const startPoint = this.getLayoutStartPoint(), _a = this._getUpdateAttribute(!1), {grid: updateGridAttrs} = _a, updateAxisAttrs = __rest(_a, [ "grid" ]), axisProduct = this._axisMark.getProduct(), axisAttrs = (0, 
        util_1.mergeSpec)({
            x: startPoint.x,
            y: startPoint.y
        }, this._axisStyle, updateAxisAttrs);
        if (axisProduct.encode(axisAttrs), this._gridMark) {
            this._gridMark.getProduct().encode((0, util_1.mergeSpec)({
                x: startPoint.x,
                y: startPoint.y
    ...
    _getTitleLimit(isX) {
        var _a, _b, _c, _d, _e;
        if (this._spec.title.visible && (0, util_1.isNil)(null === (_a = this._spec.title.style) || void 0 === _a ? void 0 : _a.maxLineWidth)) {
    ...
    _getUpdateAttribute(ignoreGrid) {
        ...
        common_1.isYAxis)(this._orient), isZ = (0, common_1.isZAxis)(this._orient);
        let end = {
            x: 0,
            y: 0
        ...
        (isX && this._layout.layoutRectLevelMap.height === constant_1.USER_LAYOUT_RECT_LEVEL || isY && this._layout.layoutRectLevelMap.width === constant_1.USER_LAYOUT_RECT_LEVEL) && (verticalMinSize = this._verticalLimitSize);
    ...
    initEvent() {
        super.initEvent(), this.visible && (this.event.on(constant_1.ChartEvent.layoutEnd, this._fixAxisOnZero), 
        this.event.on(constant_1.ChartEvent.layoutRectUpdate, (() => {
