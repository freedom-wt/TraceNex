...
const cartesian_1 = require("../../cartesian/cartesian"), type_1 = require("../../interface/type"), scale_1 = require("../../../util/scale"), constant_1 = require("../../../constant"), utils_1 = require("../../../animation/utils"), animation_1 = require("./animation"), tooltip_helper_1 = require("./tooltip-helper"), rect_1 = require("../../../mark/rect"), vrender_core_1 = require("@visactor/vrender-core"), constant_2 = require("./constant"), factory_1 = require("../../../core/factory"), config_1 = require("../../../animation/config");
...
class LinearProgressSeries extends cartesian_1.CartesianSeries {
        ...
        if (progressMark) {
            if ("vertical" === this._spec.direction) {
                ...
                this.setMarkStyle(progressMark, {
                    x: datum => {
                        var _a, _b;
                        return (0, scale_1.valueInScaleRange)(this.dataToPositionX(datum), null === (_b = null === (_a = this._xAxisHelper) || void 0 === _a ? void 0 : _a.getScale) || void 0 === _b ? void 0 : _b.call(_a, 0)) - this._spec.bandWidth / 2 + leftPadding;
                    },
                    y: datum => {
                        var _a, _b;
                ...
                this.setMarkStyle(progressMark, {
                    x: datum => {
                        var _a, _b;
                        return (0, scale_1.valueInScaleRange)(this.dataToPositionX(datum), null === (_b = null === (_a = this._xAxisHelper) || void 0 === _a ? void 0 : _a.getScale) || void 0 === _b ? void 0 : _b.call(_a, 0)) - this._xAxisHelper.dataToPosition([ 1 ], {
                            bandPosition: this._bandPosition
                        });
                    },
                    y: datum => {
                        var _a, _b;
                        return (0, scale_1.valueInScaleRange)(this.dataToPositionY(datum), null === (_b = null === (_a = this._yAxisHelper) || void 0 === _a ? void 0 : _a.getScale) || void 0 === _b ? void 0 : _b.call(_a, 0)) - this._spec.bandWidth / 2 + topPadding;
                    },
    ...
    _initTrackMarkStyle() {
        ...
        trackMark && ("vertical" === this._spec.direction ? this.setMarkStyle(trackMark, {
            x: datum => {
                var _a, _b;
                return (0, scale_1.valueInScaleRange)(this.dataToPositionX(datum), null === (_b = null === (_a = this._xAxisHelper) || void 0 === _a ? void 0 : _a.getScale) || void 0 === _b ? void 0 : _b.call(_a, 0)) - this._spec.bandWidth / 2;
            },
            y: 0,
            width: this._spec.bandWidth,
            height: () => this._scaleY.range()[0],
            cornerRadius: this._spec.cornerRadius
        }, "normal", constant_1.AttributeLevel.Series) : this.setMarkStyle(trackMark, {
            x: 0,
            y: datum => {
                var _a, _b;
                return (0, scale_1.valueInScaleRange)(this.dataToPositionY(datum), null === (_b = null === (_a = this._yAxisHelper) || void 0 === _a ? void 0 : _a.getScale) || void 0 === _b ? void 0 : _b.call(_a, 0)) - this._spec.bandWidth / 2;
            },
            height: this._spec.bandWidth,
            width: () => this._scaleX.range()[1],
            cornerRadius: this._spec.cornerRadius
        }, "normal", constant_1.AttributeLevel.Series), this._trigger.registerMark(trackMark));
    }
    ...
    _initProgressGroupMarkStyle() {
        ...
        groupMark.setZIndex(this.layoutZIndex), groupMark.created(), this.setMarkStyle(groupMark, {
            ...
            path: () => {
                ...
                return null === (_a = this._rawData) || void 0 === _a || _a.rawData.forEach(((datum, index) => {
                    var _a, _b, _c, _d;
                    if ("vertical" === this._spec.direction) {
                        const x = (0, scale_1.valueInScaleRange)(this.dataToPositionX(datum), null === (_b = null === (_a = this._xAxisHelper) || void 0 === _a ? void 0 : _a.getScale) || void 0 === _b ? void 0 : _b.call(_a, 0)) - this._spec.bandWidth / 2, height = this._scaleY.range()[0];
                        rectPaths.push((0, vrender_core_1.createRect)({
                            x: x,
                            y: 0,
                            height: height,
                            width: this._spec.bandWidth,
                        ...
                        const y = (0, scale_1.valueInScaleRange)(this.dataToPositionY(datum), null === (_d = null === (_c = this._yAxisHelper) || void 0 === _c ? void 0 : _c.getScale) || void 0 === _d ? void 0 : _d.call(_c, 0)) - this._spec.bandWidth / 2, width = this._scaleX.range()[1];
                        rectPaths.push((0, vrender_core_1.createRect)({
                            x: 0,
                            y: y,
                            height: this._spec.bandWidth,
        ...
        }, "normal", constant_1.AttributeLevel.Series), this._progressGroupMark.setInteractive(!1);
    }
    initAnimation() {
        var _a, _b, _c, _d;
...
LinearProgressSeries.mark = constant_2.linearProgressSeriesMark;
