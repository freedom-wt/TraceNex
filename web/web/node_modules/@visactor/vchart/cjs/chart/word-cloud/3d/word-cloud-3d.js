...
const type_1 = require("../../../series/interface/type"), base_1 = require("../base/base"), word_cloud_3d_1 = require("../../../series/word-cloud/word-cloud-3d"), factory_1 = require("../../../core/factory"), word_cloud_3d_transformer_1 = require("./word-cloud-3d-transformer");
...
WordCloud3dChart.seriesType = type_1.SeriesTypeEnum.wordCloud3d, WordCloud3dChart.view = "singleDefault", 
WordCloud3dChart.transformerConstructor = word_cloud_3d_transformer_1.WordCloud3dChartSpecTransformer;

const registerWordCloud3dChart = () => {
    (0, word_cloud_3d_1.registerWordCloud3dSeries)(), factory_1.Factory.registerChart(WordCloud3dChart.type, WordCloud3dChart);
};

exports.registerWordCloud3dChart = registerWordCloud3dChart;

const registerWordCloudShape3dChart = () => {
    (0, word_cloud_3d_1.registerWordCloudShape3dSeries)(), (0, exports.registerWordCloud3dChart)();
};
