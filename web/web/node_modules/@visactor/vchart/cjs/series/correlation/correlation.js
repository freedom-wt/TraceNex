...
class CorrelationSeries extends polar_1.PolarSeries {
    ...
    initData() {
        ...
        }), this._centerSeriesData = new series_data_1.SeriesData(this._option, centerDataView);
    }
    _statisticViewData() {
    ...
    initMark() {
        ...
        const nodePointMark = this._createMark(CorrelationSeries.mark.nodePoint, {
            ...
            isSeriesMark: !0,
            key: constant_2.DEFAULT_DATA_INDEX,
            customShape: null === (_a = this._spec.nodePoint) || void 0 === _a ? void 0 : _a.customShape
        });
        nodePointMark && (nodePointMark.setZIndex(constant_2.LayoutZIndex.Node), this._nodePointMark = nodePointMark);
        ...
        centerPointMark && (centerPointMark.setZIndex(constant_2.LayoutZIndex.Node), this._centerPointMark = centerPointMark);
    }
    initMarkStyle() {
    ...
    _initNodePointMarkStyle() {
        ...
        this.setMarkStyle(nodePointMark, {
            x: datum => datum[constant_3.CORRELATION_X],
            y: datum => datum[constant_3.CORRELATION_Y],
            size: datum => datum[constant_3.CORRELATION_SIZE],
            ...
            lineWidth: 0
        }, interface_1.STATE_VALUE_ENUM.STATE_NORMAL, constant_2.AttributeLevel.Series), 
...
CorrelationSeries.mark = constant_1.correlationSeriesMark, CorrelationSeries.transformerConstructor = correlation_transformer_1.CorrelationSeriesSpecTransformer;
