    ...
    initLineMarkStyle(direction, areaCurveType) {
        ...
        if (lineMark) {
            if (this.setMarkStyle(lineMark, {
                ...
                const userCurveType = null != areaCurveType ? areaCurveType : null === (_b = null === (_a = this.getSpec().line) || void 0 === _a ? void 0 : _a.style) || void 0 === _b ? void 0 : _b.curveType, curveType = userCurveType === DEFAULT_SMOOTH_INTERPOLATE ? "vertical" === direction ? "monotoneX" : "monotoneY" : userCurveType;
